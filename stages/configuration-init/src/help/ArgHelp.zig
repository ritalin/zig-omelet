...
const GuestInitialize = core.configs.guests.GuestInitialize;
pub const GuestInitializeArgId = GuestInitialize.ArgId(GuestInitialize.DescMap);
...
pub const toplevel_title_desc: Descriptor = .{ 
    ...
    .description = "Initalize setting / config scope folder.",
};
